...
if __name__ == '__main__':
    X_sm = GeneCharacterisation().bin_tract_features[0].iloc[:, 1:]
    y_sm = GeneCharacterisation().ot_fda_approvals[0]
    ...
    X_ab = GeneCharacterisation().bin_tract_features[1].iloc[:, 1:]
    y_ab = GeneCharacterisation().ot_fda_approvals[1]
