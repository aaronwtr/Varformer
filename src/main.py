...
if __name__ == "__main__":
    ...
    #           [ ] Try predicting with homogenised mvp features without embedding
    #           [ ] Find literature supporting not normalising embeddings generated by VAE
    #           [ ] Remove precision as metric
