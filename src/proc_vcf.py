...
csq_of_interest = ['5_prime_UTR_variant', 'start_retained_variant', 'start_lost', 'synonymous_variant',
                   'missense_variant', 'inframe_insertion', 'inframe_deletion', 'stop_gained', 'frameshift_variant',
                   'coding_sequence_variant', 'stop_lost', 'stop_retained_variant', 'incomplete_terminal_codon_variant',
                   '3_prime_UTR_variant']

file_names = os.listdir('../data/elgh/gh_parts/raw_vcfs')

for file_name in file_names:
    # Read the content of the file
    with open(f'../data/elgh/gh_parts/raw_vcfs/{file_name}', 'r', encoding='Windows-1252') as file:
    ...
    cols_to_keep_csq = ["Allele", "Consequence", "IMPACT", "SYMBOL", "Gene", "HGVSp", "UNIPARC",
    ...
    with open(f'../data/elgh/gh_parts/processed_gh_data/proc_{file_name}', 'w') as f:
        f.write('\t'.join(header) + '\n')
